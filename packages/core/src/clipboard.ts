...
export function normalizeCellRange(range: GridCellRange): NormalizedGridCellRange {
  return {
...
export function serializeGridRange<TRow>(options: {
...
export function getClipboardPasteCells(options: {
  ...
  const cells: ClipboardPasteCell[] = [];
